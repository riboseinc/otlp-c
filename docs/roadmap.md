...
| 1.1.3 | FreeBSD promoted from best-effort to a gating CI check (15/15 green on main — the INADDR_LOOPBACK quirk never reproduced); CLAUDE.md key-files gains exporter_sync; site /changelog renders the release history | #170 |
